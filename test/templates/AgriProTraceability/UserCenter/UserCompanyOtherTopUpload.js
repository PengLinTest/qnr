var UserCompanyOtherTopUpload;
UserCompanyOtherTopUpload || (UserCompanyOtherTopUpload = {});
var Flash = {
    getFileData: function(a, c) {
        UserCompanyOtherTopUpload.addFile(c, "data:;base64," + a)
    }
}; (function() {
    UserCompanyOtherTopUpload = {
        files: [],
        fileIndex: 0,
        fileListUL: "",
        fileItemFormat: "",
        ...
        initButton: function(a, c, d) {
            var b = UserCompanyOtherTopUpload;
            b.fileListUL = c;
            b.fileItemFormat = d;
            b.files = [];
            b.fileIndex = 0;
            	...
            	$(c).on("change",
		            function(a) {
		                if (a.target.files && 0 != a.target.files.length){
		                	if (2 <= UserCompanyOtherTopUpload.files.length){
